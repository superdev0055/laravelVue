<!-- Modal -->
<form method="POST" v-on:submit.prevent="createSistema()">
<div class="modal fade" id="create" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
          <div class="modal-content">
            <div class="modal-header">
              <h5 class="modal-title" id="exampleModalLabel">Crear nuevo Sistema</h5>
            ...
            <div class="modal-body">                    
                        ...
                        <div class="form-group">
                            ...
                            v-model="nombreBreveSiste"
                            value="{{old('nombreBreveSiste')}}">
                        ...
                        <div class="form-group">
                          ...
                          placeholder="nombre breve"
                          v-model="fechaCreaSiste"
                          value="{{old('fechaCreaSiste')}}">
                      </div>
                        <div class="form-group">
